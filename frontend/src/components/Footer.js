        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Your ultimate destination for property discovery. PropertyHub connects you with 
              premium real estate listings featuring advanced search capabilities and interactive maps to help 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <span className="block">456 PropertyHub Plaza</span>
              ...
              <li>
                <a href="mailto:info@propertyhub.com" className="hover:text-white transition-colors">
